...
const INITIAL_SALES_ORDERS: SalesOrderRecord[] = [
  ...
  { id: "7",  orderNo: "PRO-1545-693", issueDate: "01/02/2026", externalSerial: "-",         time: "01/02/2026, 04:37:", version: "0", creator: "REP khaled",          editor: "REP khaled",          clientName: "99ik",           clientCode: "_000470", geoTag: false, items: 2, total: "JOD 2,596.81", customStatus: "undamaged",  status: "invoiced",  deliveryStatus: "Undelivered",          visitId: "rep2o_223456789", linkedInvoiceId: "INV-006", itemsData: [{ id: "s7-itm1", name: "Premium Pack", sku: "PP-200", unit: "Box", totalQty: 79, deliveredQty: 79, notedQty: 0, price: 32.86, tax: 0 }, { id: "s7-itm2", name: "American Coffee", sku: "AC-500", unit: "Piece", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 0.87, tax: 0 }] },
  { id: "8",  orderNo: "PRO-1545-692", issueDate: "12/01/2026", externalSerial: "-",         time: "12/01/2026, 10:21:", version: "0", creator: "REP khaled",          editor: "REP khaled",          clientName: "new m2",         clientCode: "_000465", geoTag: false, items: 1, total: "JOD 2,596.81", customStatus: "undamaged",  status: "invoiced",  deliveryStatus: "Undelivered",          visitId: "-", linkedInvoiceId: "INV-007", itemsData: [{ id: "s8-itm1", name: "Premium Pack", sku: "PP-200", unit: "Box", totalQty: 80, deliveredQty: 0, notedQty: 0, price: 32.46, tax: 0 }] },
  { id: "9",  orderNo: "PRO-ADM-2179", issueDate: "06/04/2026", externalSerial: "sdfsdf",    time: "06/04/2026, 06:43:", version: "0", creator: "ADMIN Yousef1",       editor: "ADMIN Yousef1",       clientName: "Karak Tes",      clientCode: "_800001", geoTag: true,  items: 4, total: "JOD 4.35",     customStatus: "undamaged",  status: "invoiced",  deliveryStatus: "Partially Delivered",  visitId: "b8144831-3fa4-4ec", linkedInvoiceId: "INV-004", itemsData: [{ id: "s9-itm1", name: "American Coffee", sku: "AC-500", unit: "Piece", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 1.50, tax: 0 }, { id: "s9-itm2", name: "Croissant", sku: "CR-001", unit: "Piece", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 1.25, tax: 0 }, { id: "s9-itm3", name: "Premium Pack", sku: "PP-200", unit: "Box", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 0.85, tax: 0 }, { id: "s9-itm4", name: "Test Item 2", sku: "SKU-002", unit: "Box", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 0.75, tax: 0 }] },
  { id: "10", orderNo: "PRO-1555-135", issueDate: "06/04/2026", externalSerial: "-",         time: "06/04/2026, 02:41:", version: "0", creator: "REP Ahmad Abudre",    editor: "REP Ahmad Abudre",    clientName: "nofal0",         clientCode: "_800008", geoTag: true,  items: 2, total: "JOD 3.45",     customStatus: "undamaged",  status: "approved",  deliveryStatus: "Undelivered",          visitId: "b8144831-3fa4-4ec", itemsData: [{ id: "s10-itm1", name: "Croissant", sku: "CR-001", unit: "Piece", totalQty: 1, deliveredQty: 0, notedQty: 0, price: 1.45, tax: 0 }, { id: "s10-itm2", name: "Premium Pack", sku: "PP-200", unit: "Box", totalQty: 1, deliveredQty: 0, notedQty: 0, price: 2.00, tax: 0 }] },
...
const INITIAL_INVOICES: InvoiceRecord[] = [
  ...
  { id: "INV-004", serialNo: "INV-2026-004", externalSerial: "-",        issueDate: "06/04/2026", creator: "ADMIN Yousef1",       clientName: "Karak Tes",      items: 4, total: "JOD 4.35",     balance: "JOD 0.00",  paymentType: "Cash",     status: "APPROVED", delivery: "Delivered", comment: "-",                       sourceSOId: "9", itemsData: [{ id: "s9-itm1", name: "American Coffee", sku: "AC-500", unit: "Piece", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 1.50, tax: 0 }, { id: "s9-itm2", name: "Croissant", sku: "CR-001", unit: "Piece", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 1.25, tax: 0 }, { id: "s9-itm3", name: "Premium Pack", sku: "PP-200", unit: "Box", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 0.85, tax: 0 }, { id: "s9-itm4", name: "Test Item 2", sku: "SKU-002", unit: "Box", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 0.75, tax: 0 }] },
  { id: "INV-005", serialNo: "INV-2026-005", externalSerial: "hh",       issueDate: "06/04/2026", creator: "REP Ahmad Alshaikh",  clientName: "test 666 11717", items: 1, total: "JOD 0.75",     balance: "JOD 0.75",  paymentType: "Credit",   status: "PENDING",  delivery: "No Delivery Note",    comment: "-",                       sourceSOId: "6", itemsData: [{ id: "itm1", name: "Test Item 1", sku: "SKU-001", unit: "Piece", totalQty: 1, deliveredQty: 0, notedQty: 0, price: 0.75, tax: 0 }] },
  { id: "INV-006", serialNo: "INV-2026-006", externalSerial: "-",        issueDate: "01/02/2026", creator: "REP khaled",          clientName: "99ik",           items: 2, total: "JOD 2,596.81", balance: "JOD 0.00",  paymentType: "Cash",     status: "APPROVED", delivery: "Delivered", comment: "Paid on time",            sourceSOId: "7", itemsData: [{ id: "s7-itm1", name: "Premium Pack", sku: "PP-200", unit: "Box", totalQty: 79, deliveredQty: 79, notedQty: 0, price: 32.86, tax: 0 }, { id: "s7-itm2", name: "American Coffee", sku: "AC-500", unit: "Piece", totalQty: 1, deliveredQty: 1, notedQty: 0, price: 0.87, tax: 0 }] },
  { id: "INV-007", serialNo: "INV-2026-007", externalSerial: "-",        issueDate: "12/01/2026", creator: "REP khaled",          clientName: "new m2",         items: 1, total: "JOD 10.80",    balance: "JOD 5.40",  paymentType: "Deferred", status: "PENDING",  delivery: "Has Delivery Note",   comment: "Partial payment received", sourceSOId: "8", itemsData: [{ id: "s8-itm1", name: "Premium Pack", sku: "PP-200", unit: "Box", totalQty: 2, deliveredQty: 0, notedQty: 0, price: 5.40, tax: 0 }] },
  { id: "INV-008", serialNo: "INV-2026-008", externalSerial: "sdfsdf",   issueDate: "06/04/2026", creator: "ADMIN Yousef1",       clientName: "Gaza",           items: 2, total: "JOD 8.00",     balance: "JOD 8.00",  paymentType: "Credit",   status: "CANCELED", delivery: "No Delivery Note",    comment: "Client requested cancellation", sourceSOId: "1", itemsData: [{ id: "inv8-itm1", name: "American Coffee", sku: "AC-500", unit: "Piece", totalQty: 1, deliveredQty: 0, notedQty: 0, price: 4.00, tax: 0 }, { id: "inv8-itm2", name: "Croissant", sku: "CR-001", unit: "Piece", totalQty: 1, deliveredQty: 0, notedQty: 0, price: 4.00, tax: 0 }] },
];
