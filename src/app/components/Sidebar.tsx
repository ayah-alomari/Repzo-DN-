...
export const navItems = [
  ...
  { label: "Sales", icon: ShoppingCart, hasSubmenu: true, route: "sales", subItems: [
    ...
    { label: "Delivery Note Unloads", icon: PackageX, route: "dn-unloads" },
    { label: "Return Note", icon: ClipboardList, route: "pickup-note" },
    { label: "Reservations", icon: Bookmark, route: "reservations" },
    { label: "Reservations V2", icon: Bookmark, route: "reservations-v2" },
